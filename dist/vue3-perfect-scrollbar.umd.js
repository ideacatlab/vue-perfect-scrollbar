(function (global, factory) {
    ...
    var CustomRefImpl = function CustomRefImpl(factory) {
        ...
        var ref = factory(
            function () {
                return track(this$1, "get" /* GET */, "value");
            },
            function () {
                return trigger(this$1, "set" /* SET */, "value");
            }
        );
        var get = ref.get;
        var set = ref.set;
    ...
    var ComputedRefImpl = function ComputedRefImpl(
        getter,
        _setter,
        isReadonly
    ) {
    ...
    function formatTraceEntry(ref$$1) {
        ...
        var open =
            " at <" + formatComponentName(vnode.component, vnode.type, isRoot);
        var close = ">" + postfix;
        return vnode.props
    ...
    ErrorTypeStrings[6 /* COMPONENT_EVENT_HANDLER */] =
    ...
    ErrorTypeStrings[13 /* ASYNC_COMPONENT_LOADER */] =
        "async component loader";
    ErrorTypeStrings[14 /* SCHEDULER */] =
    ...
    var setCompiledSlotRendering = function (n) {
    ...
    */
    ...
    var Text = Symbol(
        process.env.NODE_ENV !== "production" ? "Text" : undefined
    );
    var Comment = Symbol(
    ...
    function cloneVNode(vnode, extraProps, mergeRef) {
        ...
        return (
            ...
            (obj["__v_skip" /* SKIP */] = true),
            (obj.type = vnode.type),
            (obj.props = mergedProps),
            (obj.key = mergedProps && normalizeKey(mergedProps)),
            (obj.ref =
                extraProps && extraProps.ref
                    ...
                    : ref$$1),
            (obj.scopeId = vnode.scopeId),
            (obj.children = vnode.children),
            (obj.target = vnode.target),
            (obj.targetAnchor = vnode.targetAnchor),
            (obj.staticCount = vnode.staticCount),
            (obj.shapeFlag = vnode.shapeFlag),
            (obj.patchFlag =
                extraProps && vnode.type !== Fragment
                    ...
                    : patchFlag),
            (obj.dynamicProps = vnode.dynamicProps),
            (obj.dynamicChildren = vnode.dynamicChildren),
            (obj.appContext = vnode.appContext),
            (obj.dirs = vnode.dirs),
            (obj.transition = vnode.transition),
            (obj.component = vnode.component),
            (obj.suspense = vnode.suspense),
            (obj.ssContent = vnode.ssContent && cloneVNode(vnode.ssContent)),
            (obj.ssFallback = vnode.ssFallback && cloneVNode(vnode.ssFallback)),
            (obj.el = vnode.el),
            (obj.anchor = vnode.anchor),
            obj
        );
    }
    /**
    ...
    var PublicInstanceProxyHandlers = {
        ...
        set: function set(ref$$1, key, value) {
            ...
            if (key[0] === "$" && key.slice(1) in instance) {
                process.env.NODE_ENV !== "production" &&
                    warn(
                        'Attempting to mutate public property "' +
                            key +
                            '". ' +
    ...
    function initCustomFormatter() {
        ...
        var formatter = {
            ...
            body: function body(obj) {
                if (obj && obj.__isVue) {
                    return ["div", {}].concat(formatInstance(obj.$));
                }
            },
        };
    ...
    var forcePatchProp = function (_, key) {
        return key === "value";
    };
    var patchProp = function (
        el,
        key,
        prevValue,
        nextValue,
    ...
    function resolveTransitionProps(rawProps) {
        var name = rawProps.name;
        if (name === void 0) name = "v";
        var type = rawProps.type;
        var css = rawProps.css;
        if (css === void 0) css = true;
        var duration = rawProps.duration;
        var enterFromClass = rawProps.enterFromClass;
        if (enterFromClass === void 0) enterFromClass = name + "-enter-from";
        var enterActiveClass = rawProps.enterActiveClass;
        if (enterActiveClass === void 0)
            enterActiveClass = name + "-enter-active";
        var enterToClass = rawProps.enterToClass;
        if (enterToClass === void 0) enterToClass = name + "-enter-to";
        var appearFromClass = rawProps.appearFromClass;
        if (appearFromClass === void 0) appearFromClass = enterFromClass;
        var appearActiveClass = rawProps.appearActiveClass;
        if (appearActiveClass === void 0) appearActiveClass = enterActiveClass;
        var appearToClass = rawProps.appearToClass;
        if (appearToClass === void 0) appearToClass = enterToClass;
        var leaveFromClass = rawProps.leaveFromClass;
        if (leaveFromClass === void 0) leaveFromClass = name + "-leave-from";
        var leaveActiveClass = rawProps.leaveActiveClass;
        if (leaveActiveClass === void 0)
            leaveActiveClass = name + "-leave-active";
        var leaveToClass = rawProps.leaveToClass;
        if (leaveToClass === void 0) leaveToClass = name + "-leave-to";
        var baseProps = {};
        ...
        var onBeforeAppear = baseProps.onBeforeAppear;
        if (onBeforeAppear === void 0) onBeforeAppear = onBeforeEnter;
        var onAppear = baseProps.onAppear;
        if (onAppear === void 0) onAppear = onEnter;
        var onAppearCancelled = baseProps.onAppearCancelled;
        if (onAppearCancelled === void 0) onAppearCancelled = onEnterCancelled;
            ...
            return function () {
                ...
                if (prevChildren) {
                    for (var i$1 = 0; i$1 < prevChildren.length; i$1++) {
                        ...
                        positionMap.set(
                            child$1,
                            child$1.el.getBoundingClientRect()
                        );
                    }
                }
    ...
    function keyboard(i) {
        ...
        var scrollbarFocused = function () {
            return (
                matches$1(i.scrollbarX, ":focus") ||
                matches$1(i.scrollbarY, ":focus")
            );
        };
            ...
            create: function create() {
                ...
                if (!(this.ps && this.$isServer)) {
                    ...
                    eventNames.forEach(function (eventName) {
                        this$1.ps.element.addEventListener(
                            eventName,
                            function (event) {
                                return this$1.$emit(eventName, event);
                            }
                        );
                    });
                }
        ...
        install: function (Vue, settings) {
            if (settings) {
                ...
                if (
                    ...
                    typeof settings.watchOptions === "boolean"
                ) {
                    PerfectScrollbar$1.props.watchOptions =
                        settings.watchOptions;
                }
            }
